...
; all. This happens with CTRL+F12, AltGr+..., Alt+..., LShift without RShift... This is probably related to the remote desktop session shortcut keys configuration
...
<^>!z::<
<^>!x::>
; Get < and > by pressing ALT-Gr or ALT along , and . (where it would be located were it a english keyboard)
!,::<
!.::>
<^>!,::<
<^>!.::>
; Get < and > by pressing ALT-Gr along 8 and 9
<^>!8::<
<^>!9::>
